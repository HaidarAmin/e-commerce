...
void updateHats(Function(bool success) update) async {
  try {
    final url = Uri.https(_baseURL, 'getHats.php');
...
class Hats extends StatefulWidget {
  const Hats({Key? key}) : super(key: key);
                ...
                itemBuilder: (context, index) => Column(children: [
                      ...
                      Container(
                          ...
                          child: Row(children: [
                            ...
                            Flexible(
                                child: Text(_hats[index].toString(),
                                    style: TextStyle(
